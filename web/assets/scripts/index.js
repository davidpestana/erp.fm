var Index = function () {
    ...
    return {
        ...
        initDashboardDaterange: function () {
            ...
            var dateStart = ($.cookie('texyonDateStart') !== undefined) ? new Date($.cookie('texyonDateStart')) : Date.today().add({days: -7});
            var dateEnd = ($.cookie('texyonDateEnd') !== undefined) ? new Date($.cookie('texyonDateEnd')) : Date.today();
            ...
            function (start, end) {
                ...
                $.cookie('texyonDateStart', start.toString('yyyy-MM-dd'));     //2013-01-01 , yyyy MM dd
                $.cookie('texyonDateEnd', end.toString('yyyy-MM-dd'));     //2013-01-01 , yyyy MM dd
            ...
            $('#dashboard-report-range span').html(dateStart.toString('MMMM d, yyyy') + ' - ' + dateEnd.toString('MMMM d, yyyy'));
        },
        ...
        initMsgNextRelease: function () {
                                     
                  $( "#dialog_next-release" ).dialog({
                            autoOpen: false,
                  ...
                  //console.log($( "#dialog_basic1"));
                  
                  //$( "#basic_opener1").click(function() {
                 $('.next-release').click(function(){
                     
                       $( "#dialog_next-release" ).dialog( "open" );	
