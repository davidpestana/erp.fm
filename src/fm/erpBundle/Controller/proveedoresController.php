...
use fm\erpBundle\Entity\proveedores;
use fm\erpBundle\Form\proveedoresType;
...
class proveedoresController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('erpBundle:proveedores')->findAll();
     ...
     * @Method("POST")
     * @Template("erpBundle:proveedores:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('erpBundle:proveedores')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("erpBundle:proveedores:edit.html.twig")
     */
